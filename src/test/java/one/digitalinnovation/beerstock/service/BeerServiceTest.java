...
public class BeerServiceTest {
    ...
    void whenNewBeerInformedThenShouldBeCreated() throws BeerAlreadyRegisteredException {
        ...
        Beer createdBeerDTO = beerService.createBeer(expectedSavedBeer);
    ...
    void whenValidBeerNameIsGivenThenReturnABeer() throws BeerNotFoundException {
        ...
        Beer foundBeerDTO = beerService.findByName(expectedFoundBeer.getName());
    ...
    void whenListBeerIsCalledThenReturnAListOfBeers() {
        ...
        List<Beer> foundBeerDTO = beerService.listAll();
    ...
    void whenIncrementIsCalledThenIncrementBeerStock() throws BeerNotFoundException, BeerStockExceededException {
        ...
        Beer incrementedBeerDTO = beerService.increment(expectedBeer.getId(), quantityToIncrement);
    ...
    void whenDecrementIsCalledThenDecrementBeerStock() throws BeerNotFoundException, BeerStockExceededException {
        ...
        Beer incrementedBeerDTO = beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement);
